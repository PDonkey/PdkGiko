...
//    public static String[] TITLES={CATEGORY_NAME_APP,CATEGORY_NAME_ANDROID,
//            CATEGORY_NAME_IOS,CATEGORY_NAME_FRONT_END,CATEGORY_NAME_RECOMMEND,CATEGORY_NAME_RESOURCE};
}
